...
const int width = 40;
const int height = 7;
int x = 20, y = 6, fruitX[10], fruitY[10], carX, carY;
...
void Map() {
    ...
    for (int i = 0; i < height; i++) {
        for (int j = 0; j <= width; j++) {
            ...
            else if (i == fruitY[2] && j == fruitX[2]) {
                cout << "#";
            }
            else if (i == fruitY[3] && j == fruitX[3]) {
                cout << "#";
            }
            else if (i == fruitY[4] && j == fruitX[4]) {
                cout << "#";
            }
            else if (i == fruitY[5] && j == fruitX[5]) {
                cout << "#";
            }
            else if (i == fruitY[6] && j == fruitX[6]) {
                cout << "#";
            }
            else if (i == fruitY[7] && j == fruitX[7]) {
                cout << "#";
            }
            else if (i == fruitY[8] && j == fruitX[8]) {
                cout << "#";
            }
            else {
                cout << " ";
